...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-xs-12">
            <a href="{{ route('product.show', $product->id) }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
        
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_content"> 
                    <form action="{{ route('product.update', $product->id) }}" method="post" data-parsley-validate class="form-horizontal form-label-left" >    
                        @csrf
                        @method('patch')
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" value="{{ $product->brand->name }}" id="autocomplete-custom-append" name="merk" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" value="{{ $product->name }}" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" value="{{ $product->type }}" id="type" name="type" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea class="form-control" rows="3" name="spec">{{ $product->spec }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" value="{{ $product->unit }}" id="unit" name="unit" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="category[]" class="form-control select2_multiple form-control" multiple="multiple">
                                ...
                                <option value="{{ $product_type->id }}" @foreach($product->productType as $type)<?= ($type->id == $product_type->id ? 'selected' : '') ?>@endforeach>{{ $product_type->name }}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
